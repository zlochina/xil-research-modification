...
\begin{itemize}
 ...
 test data size=1954
\end{itemize}
\itodo{Go through mentions of training and check is something differs from our model description}
...
\begin{tabular}{|l|c|c|}
 \hline
 Average accuracy with RRR loss & Training dataset & Test dataset \\
 \hline \hline

...
\end{itemize}
\itodo{Trust study. I guess, the main goal of XIL, except for correcting the model to be RRR, is building trust. Im thinking, that at some point we would need to do a survey}
...
\itodo{What about EKG dataset experiment? Do we mention it here?}

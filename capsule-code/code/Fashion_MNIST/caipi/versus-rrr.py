...
sys.path.append('code/Fashion_MNIST/caipi/rrr/rrr/')
sys.path.append('code/Fashion_MNIST/caipi/rrr/')

import numpy as np
import argparse
import matplotlib.pyplot as plt
from multilayer_perceptron import MultilayerPerceptron
from experiments.figure_grid import *
...
print("-"*42)
print("-"*42)
print("Starting RRR vs CE, on Toy Experiment - Fashion MNIST, with args:", args.fmnist, args.data_path)
print("-"*42)
...
(X_tr_orig, X_tr_decoy, y_tr, E_tr,
 X_ts_orig, X_ts_decoy, y_ts, E_ts) = \
    decoy_mnist.generate_dataset(cachefile="{}/decoy-fashion.npz".format(args.data_path), fmnist=args.fmnist)
